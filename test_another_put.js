  ...
  res.on('end', () => {
    try {
      ...
      if (sampleTask) {
        ...
        // FETCH FULL DETAILS
        http.get(
          `http://localhost:5050/api/projects/eae678e5-57bc-43b7-9d6a-dbf212cf4802/work-items/${taskId}`,
          (detailRes) => {
            let dBody = '';
            ...
            detailRes.on('end', () => {
              try {
                ...
                const putPayload = JSON.stringify({
                  ...
                  parentId: td.parentId ? td.parentId : null,
                  assigneeId: td.assigneeId ? td.assigneeId : null,
                  dueDate: td.dueDate ? td.dueDate : null,
