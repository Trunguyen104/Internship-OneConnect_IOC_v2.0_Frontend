    ...
    <div className='min-h-screen bg-gray-50 flex flex-col'>
      ...
      <main className='flex-1 w-full max-w-[1440px] mx-auto px-10 md:px-14 py-8 flex flex-col gap-10'>
        ...
        <section className='relative w-full rounded-2xl overflow-hidden shadow-sm bg-gradient-to-r from-[var(--primary-800)] to-[var(--primary-600)] text-white p-10 md:py-16 min-h-[180px] flex flex-col justify-center'>
          {/* Decorative faint rings behind text */}
        ...
        {/* Internship Info & Groups Section */}
        <section className='bg-[#e8c9c8]/30 rounded-2xl overflow-hidden border border-[#e8c9c8]/60 flex flex-col'>
          {/* Top Info Bar */}
          <div className='px-6 py-4 flex justify-between items-center bg-[#e8c9c8]/50 border-b border-[#e8c9c8]'>
            <div>
              <h2 className='text-xl md:text-2xl font-bold text-gray-900 mb-2'>
                FU Cần Thơ - Mùa xuân 2026
              </h2>
              <div className='flex flex-wrap items-center gap-3 text-xs md:text-sm text-gray-600 font-medium'>
                <span>FUCT_OJT_T1_2026</span>
                <span className='w-px h-3.5 bg-gray-400'></span>
                <span className='flex items-center gap-1.5'>
                  <CalendarOutlined /> 13/01/2026 - 11/04/2026
                </span>
                <span className='w-px h-3.5 bg-gray-400'></span>
                <span>
                  Sinh viên tham gia: <strong className='text-gray-900'>9</strong>
                </span>
                <span className='w-px h-3.5 bg-gray-400'></span>
                <span>
            ...
            <button className='w-9 h-9 rounded-full bg-[var(--primary-800)]/90 text-white flex items-center justify-center hover:bg-[var(--primary-800)] transition-colors cursor-pointer shadow-sm'>
              <RightOutlined className='text-sm ml-0.5' />
            </button>
          </div>
          ...
          <div className='p-6 bg-transparent'>
            <div
              onClick={() => router.push('/student/space')}
              className='bg-white rounded-xl border border-gray-100 p-5 flex flex-col lg:flex-row gap-8 cursor-pointer hover:shadow-lg hover:border-gray-200 transition-all group'
            >
              ...
              <div className='flex-1 py-1 flex flex-col justify-center'>
                ...
                <div className='flex items-center gap-3 mb-6'>
                  <h3 className='text-[19px] font-bold text-gray-900 group-hover:text-(--primary-700) transition-colors'>
                    FU Cần Thơ - Mùa xuân 2026 - IOC (C#, React)
                  </h3>
                  <span className='px-3.5 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full border border-blue-100'>
                    Đang hoạt động
                  </span>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-y-7 gap-x-8'>
                  ...
                  <div className='flex items-center gap-3.5'>
                    ...
                    <div>
                      ...
                      <p className='text-[15px] font-bold text-gray-900'>Trần Doãn Đô</p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center gap-3.5'>
                    ...
                    <div>
                      ...
                      <p className='text-[15px] font-bold text-gray-900'>IOC Version 2</p>
                    </div>
                  </div>

                  {/* Lĩnh vực */}
                  <div className='flex items-center gap-3.5'>
                    <div className='w-11 h-11 rounded-full bg-indigo-500/20 flex items-center justify-center text-indigo-600 shrink-0'>
                      <svg
                        className='w-5 h-5'
                        fill='none'
                        viewBox='0 0 24 24'
                    ...
                    <div>
                      ...
                      <p className='text-[15px] font-bold text-gray-900'>Công nghệ thông tin</p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center gap-3.5'>
                    ...
                    <div>
                      ...
                      <p className='text-[15px] font-bold text-gray-900'>Rikkeisoft</p>
                    </div>
                  </div>
                </div>
              </div>
