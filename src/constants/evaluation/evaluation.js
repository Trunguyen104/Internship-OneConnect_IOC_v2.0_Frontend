export const EVALUATION_UI = {
  ...
  LABELS: {
    ...
    SELECT_PHASE_PLACEHOLDER: 'Select phase...',
    SELECT_GROUP_PLACEHOLDER: 'Select internship group...',
    SELECT_GROUP_PROMPT:
      'Please select an internship group from the list above to view evaluation.',
