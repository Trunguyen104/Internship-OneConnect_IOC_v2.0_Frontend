...
export default function UpdateTaskModal({ open, onClose, onSubmit, epics = [], sprints = [], initialData = null }) {
        ...
        if (open && initialData) {
            ...
            if (!sid) {
                for (const sp of sprints) {
                    if (sp.items?.find((i) => (i.workItemId || i.id) === (initialData.workItemId || initialData.id))) {
                        sid = sp.sprintId;
                        break;
                    }
                }
            ...
            setPoints(initialData.storyPoint !== undefined && initialData.storyPoint !== null ? String(initialData.storyPoint) : (initialData.points !== undefined && initialData.points !== null ? String(initialData.points) : ''));
        }
